...
def get_2_real_element(a: int,b: int, c: int) -> int:
    delta = b**2 - 4*a*c
    return delta > 0

def test_2_real_element(capsys): #capture system - pobiera eventy systemowe, mozna dzieki temu pobierac to co zwraca program
    # try
    a = 2
    b = 5
    c = 3
    ...
    #when
    result = get_2_real_element(a, b, c)
